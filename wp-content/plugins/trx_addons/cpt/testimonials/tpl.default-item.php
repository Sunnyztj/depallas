...
<div class="sc_testimonials_item">
	<?php if ( has_post_thumbnail() ) { ?>
		<div class="sc_testimonials_item_author_avatar"><?php the_post_thumbnail( apply_filters('trx_addons_filter_testimonials_thumb_size', trx_addons_get_thumb_size('avatar')), array('alt' => get_the_title()) ); ?></div>
	<?php } ?>
