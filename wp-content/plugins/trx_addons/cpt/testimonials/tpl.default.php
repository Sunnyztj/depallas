...
if ($query->found_posts > 0) {
	...
	?><div class="sc_testimonials sc_testimonials_<?php
			...
			if ($args['slider']) echo ' swiper-slider-container slider_swiper slider_noresize slider_controls '.($args['slider_pagination'] > 0 ? 'slider_pagination' : 'slider_nopagination'); 
		...
		if ($args['slider']) {
			echo '<div class="slider_controls_wrap">'
				. '<a class="slider_prev swiper-button-prev no_bg" href="#"></a>'
				. '<a class="slider_next swiper-button-next no_bg" href="#"></a>'
			. '</div>' ;
		}
