...
if (have_posts()) {
	...
	$luxury_wine_classes = 'posts_container '
						. (substr(luxury_wine_get_theme_option('blog_style'), 0, 7) == 'classic' ? 'columns_wrap' : 'masonry_wrap');
	...
	while ( have_posts() ) { the_post(); 
		...
		get_template_part( 'content', $luxury_wine_sticky_out && is_sticky() ? 'sticky' : 'classic' );
	}
